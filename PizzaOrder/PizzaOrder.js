...
var _user$project$Config$urlPizzaList = 'http://localhost:3008/pizza/';
var _user$project$Config$urlOrderPut = 'http://localhost:3008/order?id=';
var _user$project$Config$urlOrder = 'http://localhost:3008/order/';
var _user$project$Config$urlOrderList = 'http://localhost:3008/order/';

var _user$project$PizzaOrderModel$Topping = F2(
	function (a, b) {
		return {id: a, name: b};
	});
var _user$project$PizzaOrderModel$toppingslist = {
	ctor: '::',
	_0: A2(_user$project$PizzaOrderModel$Topping, '1', 'Ham'),
	_1: {
		ctor: '::',
		_0: A2(_user$project$PizzaOrderModel$Topping, '2', 'Cheese'),
		_1: {
			ctor: '::',
			_0: A2(_user$project$PizzaOrderModel$Topping, '3', 'Olives'),
			_1: {ctor: '[]'}
		}
	}
};
var _user$project$PizzaOrderModel$PizzaOrder = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
						...
						return function (g) {
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return {pizzaname: a, pizzaid: b, toppings: c, size: d, quantity: e, price: f, total: g, customer: h, timestamp: i, pending: j, ready: k};
										};
									};
								};
							};
...
var _user$project$PizzaOrderModel$defaultpizzaorder = _user$project$PizzaOrderModel$PizzaOrder('')('')(
	{ctor: '[]'})('')('1')(0.0)(0.0)('')('')(true)(false);
var _user$project$PizzaOrderModel$Customer = F7(
	function (a, b, c, d, e, f, g) {
		return {name: a, address: b, telephone: c, ordered: d, selected: e, time: f, amount: g};
	});
var _user$project$PizzaOrderModel$initialTempOrder = A7(
	_user$project$PizzaOrderModel$Customer,
	'',
	'',
	'',
	{ctor: '[]'},
	_user$project$PizzaOrderModel$defaultpizzaorder,
	'',
	0.0);
var _user$project$PizzaOrderModel$Model = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
								...
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return function (m) {
													return {temporder: a, orders: b, total: c, currenttime: d, timestamp: e, flags: f, page: g, history: h, pizze: i, allorders: j, status: k, customer: l, tableState: m};
												};
											};
										};
									};
...
var _user$project$PizzaOrderModel$OrderDto = F8(
	function (a, b, c, d, e, f, g, h) {
		return {id: a, pizza: b, quantity: c, price: d, total: e, pending: f, ready: g, customer: h};
	});
var _user$project$PizzaOrderModel$Pizza = F4(
	function (a, b, c, d) {
		return {id: a, name: b, price: c, description: d};
	});
var _user$project$PizzaOrderModel$defaultpizza = A4(_user$project$PizzaOrderModel$Pizza, '', '', '', '');
var _user$project$PizzaOrderModel$pizzalist = {
	ctor: '::',
	_0: A4(_user$project$PizzaOrderModel$Pizza, '1', 'Calzone', '8.95', 'Folded with bacon, ham, mozzarella and olives.'),
	_1: {
		ctor: '::',
		_0: A4(_user$project$PizzaOrderModel$Pizza, '2', 'Margherita', '8.95', 'Classic mozzarella cheese and tomato sauce.'),
		_1: {
			ctor: '::',
			_0: A4(_user$project$PizzaOrderModel$Pizza, '3', 'Rustica', '9.95', 'Vegetarian with mozzarella, tomato and rucola.'),
			_1: {
				ctor: '::',
				_0: A4(_user$project$PizzaOrderModel$Pizza, '4', 'Hawaiian', '9.95', 'Smoked leg ham with pineapple with more mozzarella.'),
				_1: {ctor: '[]'}
			}
		}
	}
};
var _user$project$PizzaOrderModel$Flags = function (a) {
	return {dummyflag: a};
};
var _user$project$PizzaOrderModel$OrdersPage = {ctor: 'OrdersPage'};
var _user$project$PizzaOrderModel$HomePage = {ctor: 'HomePage'};
var _user$project$PizzaOrderModel$initialModel = _user$project$PizzaOrderModel$Model(
	A7(
		_user$project$PizzaOrderModel$Customer,
		'',
		'',
		...
		0.0))(
	{ctor: '[]'})(0.0)('')('')(
	_user$project$PizzaOrderModel$Flags(0))(_user$project$PizzaOrderModel$HomePage)(
	{ctor: '[]'})(_user$project$PizzaOrderModel$pizzalist)(
	{ctor: '[]'})('')('')(
	_evancz$elm_sortable_table$Table$initialSort('Name'));
var _user$project$PizzaOrderModel$SetTableState = function (a) {
	return {ctor: 'SetTableState', _0: a};
};
var _user$project$PizzaOrderModel$ToggleSelected = function (a) {
	return {ctor: 'ToggleSelected', _0: a};
};
var _user$project$PizzaOrderModel$NewUrl = function (a) {
	return {ctor: 'NewUrl', _0: a};
};
var _user$project$PizzaOrderModel$UrlChanged = function (a) {
	return {ctor: 'UrlChanged', _0: a};
};
var _user$project$PizzaOrderModel$CurrentTime = function (a) {
	return {ctor: 'CurrentTime', _0: a};
};
var _user$project$PizzaOrderModel$Quantity = function (a) {
	return {ctor: 'Quantity', _0: a};
};
var _user$project$PizzaOrderModel$IncrementQuantity = {ctor: 'IncrementQuantity'};
var _user$project$PizzaOrderModel$InputTelephone = function (a) {
	return {ctor: 'InputTelephone', _0: a};
};
var _user$project$PizzaOrderModel$InputAddress = function (a) {
	return {ctor: 'InputAddress', _0: a};
};
var _user$project$PizzaOrderModel$InputName = function (a) {
	return {ctor: 'InputName', _0: a};
};
var _user$project$PizzaOrderModel$CancelOrder = {ctor: 'CancelOrder'};
var _user$project$PizzaOrderModel$ConfirmOrder = {ctor: 'ConfirmOrder'};
var _user$project$PizzaOrderModel$Pizze = function (a) {
	return {ctor: 'Pizze', _0: a};
};
var _user$project$PizzaOrderModel$OrderCreated = function (a) {
	return {ctor: 'OrderCreated', _0: a};
};
var _user$project$PizzaOrderModel$Orders = function (a) {
	return {ctor: 'Orders', _0: a};
};
var _user$project$PizzaOrderModel$RemoveTopping = function (a) {
	return {ctor: 'RemoveTopping', _0: a};
};
var _user$project$PizzaOrderModel$SetTopping = function (a) {
	return {ctor: 'SetTopping', _0: a};
};
var _user$project$PizzaOrderModel$SetPizza = function (a) {
	return {ctor: 'SetPizza', _0: a};
};
var _user$project$PizzaOrderModel$SelectPizza = function (a) {
	return {ctor: 'SelectPizza', _0: a};
};
var _user$project$PizzaOrderModel$AddOrder = {ctor: 'AddOrder'};
var _user$project$PizzaOrderModel$NoOp = {ctor: 'NoOp'};

var _user$project$PizzaOrderBusinessLogic$resolveOrder = function (o) {
	return A8(_user$project$PizzaOrderModel$OrderDto, o.timestamp, o.pizzaname, o.quantity, o.price, o.total, o.pending, o.ready, o.customer);
};
var _user$project$PizzaOrderBusinessLogic$resolveOrderDto = function (o) {
	var p = _user$project$PizzaOrderModel$defaultpizzaorder;
	return _elm_lang$core$Native_Utils.update(
		p,
		{pizzaname: o.pizza, pizzaid: '', quantity: o.quantity, price: o.price, total: o.total, pending: o.pending, ready: o.ready, timestamp: o.id, customer: o.customer});
};
var _user$project$PizzaOrderBusinessLogic$resolveOrderDtoList = function (l) {
	var p = _user$project$PizzaOrderModel$defaultpizzaorder;
	return A2(
		_elm_lang$core$List$map,
		function (o) {
...
var _user$project$PizzaOrderBusinessLogic$customerString = function (c) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		c.name,
		A2(
			...
			A2(
				_elm_lang$core$Basics_ops['++'],
				c.address,
				A2(_elm_lang$core$Basics_ops['++'], '/', c.telephone))));
};
var _user$project$PizzaOrderBusinessLogic$getOrdersReady = function (l) {
	return A2(
		_elm_lang$core$List$filter,
		function (item) {
			return _elm_lang$core$Native_Utils.eq(item.pending, false) && _elm_lang$core$Native_Utils.eq(item.ready, true);
		},
		l);
};
var _user$project$PizzaOrderBusinessLogic$getOrdersPending = function (l) {
	return A2(
		_elm_lang$core$List$filter,
		function (item) {
			return _elm_lang$core$Native_Utils.eq(item.pending, true);
		},
		l);
};
var _user$project$PizzaOrderBusinessLogic$getPizzaById = F2(
	function (pizzaid, plist) {
		var pizza = A2(
			_elm_community$list_extra$List_Extra$find,
			function (item) {
				return _elm_lang$core$Native_Utils.eq(item.id, pizzaid);
			},
			plist);
		return A2(_elm_lang$core$Maybe$withDefault, _user$project$PizzaOrderModel$defaultpizza, pizza);
	});
var _user$project$PizzaOrderBusinessLogic$calculateToppingsString = function (toppings) {
	var l = A2(
		_elm_lang$core$List$map,
		function (item) {
			return A2(_elm_lang$core$Basics_ops['++'], ' ', item.name);
		},
		toppings);
	return A3(
		_elm_lang$core$List$foldl,
...
var _user$project$PizzaOrderBusinessLogic$calculateTotal = function (l) {
	var lp = A2(
		_elm_lang$core$List$map,
		function (item) {
			return item.total;
...
var _user$project$PizzaOrderBusinessLogic$calculateOrder = function (order) {
	var o = A2(
		_elm_lang$core$Basics_ops['++'],
		order.quantity,
		A2(_elm_lang$core$Basics_ops['++'], 'x ', order.pizzaname));
	return A2(
		_elm_lang$core$Basics_ops['++'],
		' [{\"text\":\" ',
		A2(_elm_lang$core$Basics_ops['++'], o, ' \"}] '));
};
var _user$project$PizzaOrderBusinessLogic$calculateOrderNumber = function (model) {
	return '2';
};

var _user$project$PizzaOrderUpdate$removeTopping = F2(
	function (topping, toppings) {
		var _p0 = A2(
			_elm_lang$core$List$partition,
			function (x) {
				return !_elm_lang$core$Native_Utils.eq(x.name, topping);
			},
			toppings);
		var t = _p0._0;
		return t;
	});
var _user$project$PizzaOrderUpdate$encoderOrder = function (order) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
			...
			_1: {
				...
				_0: {
					ctor: '_Tuple2',
					_0: 'pizza',
					_1: _elm_lang$core$Json_Encode$string(order.pizza)
				},
				_1: {
					ctor: '::',
					_0: {
						ctor: '_Tuple2',
						_0: 'quantity',
						_1: _elm_lang$core$Json_Encode$string(order.quantity)
					},
					_1: {
						ctor: '::',
						_0: {
							ctor: '_Tuple2',
							_0: 'price',
							_1: _elm_lang$core$Json_Encode$float(order.price)
						},
						_1: {
							ctor: '::',
							_0: {
								ctor: '_Tuple2',
								_0: 'total',
								_1: _elm_lang$core$Json_Encode$float(order.total)
							},
							_1: {
								ctor: '::',
								_0: {
									ctor: '_Tuple2',
									_0: 'pending',
									_1: _elm_lang$core$Json_Encode$bool(order.pending)
								},
								_1: {
									ctor: '::',
									_0: {
										ctor: '_Tuple2',
										_0: 'ready',
										_1: _elm_lang$core$Json_Encode$bool(order.ready)
									},
									_1: {
										ctor: '::',
										_0: {
											ctor: '_Tuple2',
											_0: 'customer',
											_1: _elm_lang$core$Json_Encode$string(order.customer)
										},
										_1: {ctor: '[]'}
									}
								}
...
var _user$project$PizzaOrderUpdate$decodeOrder = A9(
	_elm_lang$core$Json_Decode$map8,
	_user$project$PizzaOrderModel$OrderDto,
	A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'pizza', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'quantity', _elm_lang$core$Json_Decode$string),
	A2(_elm_lang$core$Json_Decode$field, 'price', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode$field, 'total', _elm_lang$core$Json_Decode$float),
	A2(_elm_lang$core$Json_Decode$field, 'pending', _elm_lang$core$Json_Decode$bool),
	A2(_elm_lang$core$Json_Decode$field, 'ready', _elm_lang$core$Json_Decode$bool),
	A2(_elm_lang$core$Json_Decode$field, 'customer', _elm_lang$core$Json_Decode$string));
var _user$project$PizzaOrderUpdate$postOrder = function (order) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$PizzaOrderModel$OrderCreated,
		_elm_lang$http$Http$request(
			{
				method: 'POST',
				headers: {ctor: '[]'},
				url: _user$project$Config$urlOrder,
				body: _elm_lang$http$Http$jsonBody(
					_user$project$PizzaOrderUpdate$encoderOrder(order)),
				expect: _elm_lang$http$Http$expectJson(_user$project$PizzaOrderUpdate$decodeOrder),
				timeout: _elm_lang$core$Maybe$Nothing,
				withCredentials: false
			}));
};
var _user$project$PizzaOrderUpdate$patchOrder = function (order) {
	return A2(
		_elm_lang$http$Http$send,
		_user$project$PizzaOrderModel$OrderCreated,
		_elm_lang$http$Http$request(
			{
				method: 'PUT',
				headers: {ctor: '[]'},
				url: A2(_elm_lang$core$Basics_ops['++'], _user$project$Config$urlOrderPut, order.id),
				body: _elm_lang$http$Http$jsonBody(
					_user$project$PizzaOrderUpdate$encoderOrder(order)),
				expect: _elm_lang$http$Http$expectJson(_user$project$PizzaOrderUpdate$decodeOrder),
				timeout: _elm_lang$core$Maybe$Nothing,
...
var _user$project$PizzaOrderUpdate$decodePizzaList = _elm_lang$core$Json_Decode$list(
	A5(
		_elm_lang$core$Json_Decode$map4,
		_user$project$PizzaOrderModel$Pizza,
		A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'name', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'price', _elm_lang$core$Json_Decode$string),
		A2(_elm_lang$core$Json_Decode$field, 'description', _elm_lang$core$Json_Decode$string)));
var _user$project$PizzaOrderUpdate$getPizzaList = function () {
	var url = _user$project$Config$urlPizzaList;
	return A2(
		_elm_lang$http$Http$send,
		_user$project$PizzaOrderModel$Pizze,
		A2(_elm_lang$http$Http$get, url, _user$project$PizzaOrderUpdate$decodePizzaList));
}();
var _user$project$PizzaOrderUpdate$decodeOrderList = _elm_lang$core$Json_Decode$list(
	A9(
		_elm_lang$core$Json_Decode$map8,
		_user$project$PizzaOrderModel$OrderDto,
		A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$string),
		...
		A2(_elm_lang$core$Json_Decode$field, 'ready', _elm_lang$core$Json_Decode$bool),
		A2(_elm_lang$core$Json_Decode$field, 'customer', _elm_lang$core$Json_Decode$string)));
var _user$project$PizzaOrderUpdate$getOrderList = function () {
	var url = _user$project$Config$urlOrderList;
	return A2(
		_elm_lang$http$Http$send,
		_user$project$PizzaOrderModel$Orders,
		A2(_elm_lang$http$Http$get, url, _user$project$PizzaOrderUpdate$decodeOrderList));
}();
var _user$project$PizzaOrderUpdate$getPage = function (hash) {
	var _p1 = hash;
	switch (_p1) {
		case '#home':
			return _user$project$PizzaOrderModel$HomePage;
		case '#orders':
			return _user$project$PizzaOrderModel$OrdersPage;
		default:
			return _user$project$PizzaOrderModel$HomePage;
	}
};
var _user$project$PizzaOrderUpdate$update = F2(
	function (msg, model) {
		var _p2 = msg;
		switch (_p2.ctor) {
			case 'NoOp':
			...
			case 'AddOrder':
				var to = model.temporder.ordered;
				var t = model.temporder;
				var t_ = _elm_lang$core$Native_Utils.update(
					_user$project$PizzaOrderModel$initialTempOrder,
					{
						ordered: {ctor: '::', _0: t.selected, _1: to}
					});
				var m = _user$project$PizzaOrderModel$Model(
					_elm_lang$core$Native_Utils.update(
						t_,
						{time: model.currenttime, amount: t.amount}))(model.orders)(t.amount)(model.currenttime)(model.timestamp)(model.flags)(model.page)(model.history)(model.pizze)(model.allorders)(model.status)(model.customer)(model.tableState);
				return {ctor: '_Tuple2', _0: m, _1: _elm_lang$core$Platform_Cmd$none};
			case 'ConfirmOrder':
				var p = _user$project$PizzaOrderBusinessLogic$calculateTotal(model.temporder.ordered);
				var to = model.temporder.ordered;
				var to_ = A2(_elm_lang$core$List$append, model.orders, to);
				var m = _user$project$PizzaOrderModel$Model(_user$project$PizzaOrderModel$initialTempOrder)(to_)(p)(model.currenttime)(model.timestamp)(model.flags)(model.page)(model.history)(model.pizze)(model.allorders)(model.status)(
					_user$project$PizzaOrderBusinessLogic$customerString(model.temporder))(model.tableState);
				return {
					ctor: '_Tuple2',
					_0: m,
					_1: _user$project$PizzaOrderUpdate$postOrder(
						_user$project$PizzaOrderBusinessLogic$resolveOrder(
							A2(
								_elm_lang$core$Maybe$withDefault,
								_user$project$PizzaOrderModel$defaultpizzaorder,
								_elm_lang$core$List$head(to_))))
				};
			case 'CancelOrder':
				return {ctor: '_Tuple2', _0: _user$project$PizzaOrderModel$initialModel, _1: _elm_lang$core$Platform_Cmd$none};
			case 'InputName':
				var t = model.temporder;
				var m = _user$project$PizzaOrderModel$Model(
					_elm_lang$core$Native_Utils.update(
						t,
						{name: _p2._0}))(model.orders)(model.total)(model.currenttime)(model.timestamp)(model.flags)(model.page)(model.history)(model.pizze)(model.allorders)(model.status)(model.customer)(model.tableState);
				return {ctor: '_Tuple2', _0: m, _1: _elm_lang$core$Platform_Cmd$none};
			case 'InputAddress':
				var t = model.temporder;
				var m = _user$project$PizzaOrderModel$Model(
					_elm_lang$core$Native_Utils.update(
						t,
						{address: _p2._0}))(model.orders)(model.total)(model.currenttime)(model.timestamp)(model.flags)(model.page)(model.history)(model.pizze)(model.allorders)(model.status)(model.customer)(model.tableState);
				return {ctor: '_Tuple2', _0: m, _1: _elm_lang$core$Platform_Cmd$none};
			case 'InputTelephone':
				var t = model.temporder;
				var m = _user$project$PizzaOrderModel$Model(
					_elm_lang$core$Native_Utils.update(
						t,
						{telephone: _p2._0}))(model.orders)(model.total)(model.currenttime)(model.timestamp)(model.flags)(model.page)(model.history)(model.pizze)(model.allorders)(model.status)(model.customer)(model.tableState);
				return {ctor: '_Tuple2', _0: m, _1: _elm_lang$core$Platform_Cmd$none};
			case 'SelectPizza':
				return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
			case 'SetPizza':
				var pz = A2(_user$project$PizzaOrderBusinessLogic$getPizzaById, _p2._0, model.pizze);
				var prz_ = A2(
					_elm_lang$core$Result$withDefault,
					0.0,
					_elm_lang$core$String$toFloat(pz.price));
				var prz = A2(
					_elm_lang$core$Result$withDefault,
					0.0,
				...
				var tot_ = prz_ * A2(
					_elm_lang$core$Result$withDefault,
					1.0,
					_elm_lang$core$String$toFloat(s.quantity));
				var tot = A2(
					_elm_lang$core$Result$withDefault,
					0.0,
					_elm_lang$core$String$toFloat(
						A2(
							...
							_krisajenkins$formatting$Formatting$roundTo(2),
							tot_)));
				var s_ = _elm_lang$core$Native_Utils.update(
					s,
					{pizzaname: pz.name, price: prz, pizzaid: pz.id, total: tot, timestamp: model.timestamp});
				var m = _user$project$PizzaOrderModel$Model(
					_elm_lang$core$Native_Utils.update(
						t,
						{selected: s_}))(model.orders)(model.total)(model.currenttime)(model.timestamp)(model.flags)(model.page)(model.history)(model.pizze)(model.allorders)(model.status)(model.customer)(model.tableState);
				return {ctor: '_Tuple2', _0: m, _1: _elm_lang$core$Platform_Cmd$none};
			case 'SetTopping':
				var _p3 = _p2._0;
				var topp = A2(_user$project$PizzaOrderModel$Topping, _p3, _p3);
				var t = model.temporder;
				var s = t.selected;
				var s_ = _elm_lang$core$Native_Utils.update(
					s,
					{
						toppings: {ctor: '::', _0: topp, _1: s.toppings}
					});
				var m = _user$project$PizzaOrderModel$Model(
					_elm_lang$core$Native_Utils.update(
						t,
			...
			case 'RemoveTopping':
				...
				var s_ = _elm_lang$core$Native_Utils.update(
					s,
					{
						toppings: A2(_user$project$PizzaOrderUpdate$removeTopping, _p2._0, s.toppings)
					});
				var m = _user$project$PizzaOrderModel$Model(
					_elm_lang$core$Native_Utils.update(
						t,
			...
			case 'IncrementQuantity':
				var t = model.temporder;
				var s = t.selected;
				var qu = _elm_lang$core$Basics$toString(
					A2(
						_elm_lang$core$Result$withDefault,
						0,
						_elm_lang$core$String$toInt(s.quantity)) + 1);
				var tot_ = s.price * A2(
					_elm_lang$core$Result$withDefault,
					1.0,
					_elm_lang$core$String$toFloat(qu));
				var tot = A2(
					_elm_lang$core$Result$withDefault,
					0.0,
					_elm_lang$core$String$toFloat(
				...
				if (_p2._0.ctor === 'Ok') {
					...
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							...
							{
								allorders: _p4,
								orders: _user$project$PizzaOrderBusinessLogic$resolveOrderDtoList(_p4)
							}),
			...
			case 'CurrentTime':
				...
				var currentplus = A2(
					_elm_community$elm_time$Time_DateTime$addMinutes,
					(_elm_lang$core$List$length(t.ordered) + 1) * 1,
					_elm_community$elm_time$Time_DateTime$fromTimestamp(_p5));
				var s = A2(
					_elm_lang$core$Basics_ops['++'],
					_elm_lang$core$Basics$toString(
						_elm_community$elm_time$Time_DateTime$hour(currentplus)),
					A2(
						_elm_lang$core$Basics_ops['++'],
						':',
						_elm_lang$core$Basics$toString(
							_elm_community$elm_time$Time_DateTime$minute(currentplus))));
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							currenttime: s,
							timestamp: _elm_lang$core$Basics$toString(_p5)
						}),
					{
						ctor: '::',
						_0: _user$project$PizzaOrderUpdate$getOrderList,
						_1: {ctor: '[]'}
					});
			case 'UrlChanged':
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{
							page: _user$project$PizzaOrderUpdate$getPage(_p2._0.hash)
						}),
					{ctor: '[]'});
			case 'NewUrl':
				return {
			...
			case 'ToggleSelected':
				var _p6 = _p2._0;
				var p_ = _elm_lang$core$Native_Utils.update(
					_p6,
				...
				var ol_ = A2(
					_elm_lang$core$List$filter,
					function (item) {
						return !_elm_lang$core$Native_Utils.eq(item.pizzaid, _p6.pizzaid);
					},
					ol);
				var olchanged = {ctor: '::', _0: p_, _1: ol_};
				var m = _user$project$PizzaOrderModel$Model(model.temporder)(olchanged)(model.total)(model.currenttime)(model.timestamp)(model.flags)(model.page)(model.history)(model.pizze)(model.allorders)(model.status)(model.customer)(model.tableState);
				return {
					ctor: '_Tuple2',
					_0: m,
					_1: _user$project$PizzaOrderUpdate$patchOrder(
						_user$project$PizzaOrderBusinessLogic$resolveOrder(p_))
				};
			default:
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
...
var _user$project$PizzaOrderView$defineConfirmOrderButtonState = function (customer) {
	var plistcount = _elm_lang$core$List$isEmpty(customer.ordered);
	var ptelephone = _elm_lang$core$String$isEmpty(customer.telephone);
	var paddress = _elm_lang$core$String$isEmpty(customer.address);
	var pname = _elm_lang$core$String$isEmpty(customer.name);
	var predicate = pname || (paddress || (ptelephone || plistcount));
	var _p0 = predicate;
	if (_p0 === true) {
		return ' disabled';
	} else {
...
var _user$project$PizzaOrderView$defineAddOrderButtonState = function (selected) {
	var _p1 = _elm_lang$core$String$isEmpty(selected.pizzaname);
	if (_p1 === true) {
		return ' disabled';
	} else {
		return '';
...
var _user$project$PizzaOrderView$toRowAttrsDone = function (p) {
	return {ctor: '[]'};
};
var _user$project$PizzaOrderView$tableconfigDone = _evancz$elm_sortable_table$Table$customConfig(
	{
		toId: function (_) {
			return _.pizzaid;
		},
		toMsg: _user$project$PizzaOrderModel$SetTableState,
		columns: {
			ctor: '::',
			_0: A2(
		...
		customizations: _elm_lang$core$Native_Utils.update(
			...
			{rowAttrs: _user$project$PizzaOrderView$toRowAttrsDone})
	});
var _user$project$PizzaOrderView$renderOrdersDone = F2(
	function (l, tablestate) {
		return A3(_evancz$elm_sortable_table$Table$view, _user$project$PizzaOrderView$tableconfigDone, tablestate, l);
	});
var _user$project$PizzaOrderView$viewCheckbox = function (_p2) {
	var _p3 = _p2;
	return A2(
		_evancz$elm_sortable_table$Table$HtmlDetails,
		{ctor: '[]'},
...
var _user$project$PizzaOrderView$checkboxColumn = _evancz$elm_sortable_table$Table$veryCustomColumn(
	{name: 'Ready', viewData: _user$project$PizzaOrderView$viewCheckbox, sorter: _evancz$elm_sortable_table$Table$unsortable});
var _user$project$PizzaOrderView$toRowAttrs = function (p) {
	return {
		ctor: '::',
		_0: _elm_lang$html$Html_Events$onClick(
			_user$project$PizzaOrderModel$ToggleSelected(p)),
		_1: {ctor: '[]'}
	};
};
var _user$project$PizzaOrderView$tableconfig = _evancz$elm_sortable_table$Table$customConfig(
	{
		toId: function (_) {
			return _.pizzaid;
		},
		...
		columns: {
			ctor: '::',
			_0: _user$project$PizzaOrderView$checkboxColumn,
			_1: {
				ctor: '::',
				_0: A2(
					_evancz$elm_sortable_table$Table$stringColumn,
		...
		customizations: _elm_lang$core$Native_Utils.update(
			_evancz$elm_sortable_table$Table$defaultCustomizations,
			{rowAttrs: _user$project$PizzaOrderView$toRowAttrs})
	});
var _user$project$PizzaOrderView$renderOrdersTodo = F2(
	function (l, tablestate) {
		return A3(_evancz$elm_sortable_table$Table$view, _user$project$PizzaOrderView$tableconfig, tablestate, l);
	});
var _user$project$PizzaOrderView$renderOrderFooter = function (l) {
	var total = _user$project$PizzaOrderBusinessLogic$calculateTotal(l);
	return A2(
...
var _user$project$PizzaOrderView$renderList = function (l) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
								...
								A2(
									...
									A2(
										...
										A2(
											_elm_lang$core$Basics_ops['++'],
											'; ',
											_user$project$PizzaOrderBusinessLogic$calculateToppingsString(item.toppings)))))),
						_1: {ctor: '[]'}
					});
			},
			l));
};
var _user$project$PizzaOrderView$renderToppingListItem = function (t) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
				...
				_elm_lang$html$Html$input,
				{
					...
					_1: {
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(t.name),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id(t.id),
									_1: {ctor: '[]'}
								}
							}
						}
			...
			_1: {
				...
				_0: A2(
					_elm_lang$html$Html$label,
					{
						...
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$for(t.id),
							_1: {ctor: '[]'}
						}
					},
					{
...
var _user$project$PizzaOrderView$renderToppingList = function (l) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
			_elm_lang$core$List$map,
			function (item) {
				return _user$project$PizzaOrderView$renderToppingListItem(item);
			},
			l));
};
var _user$project$PizzaOrderView$renderPizzaList = function (p) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		A2(
				...
				return A2(
					_elm_lang$html$Html$button,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-pizzaid', item.id),
								_1: {ctor: '[]'}
							}
						}
					},
					{
						...
						_0: _elm_lang$html$Html$text(
							A2(
								_elm_lang$core$Basics_ops['++'],
								item.name,
								A2(_elm_lang$core$Basics_ops['++'], ' ', item.price))),
						_1: {ctor: '[]'}
					});
			},
			p));
};
var _user$project$PizzaOrderView$renderPizzaSpinner = function (m) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('pizzaspinner'),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('input-group-btn btn-group-sm'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$button,
						{
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: A2(_elm_lang$html$Html_Attributes$attribute, 'data-action', 'decrementQtyPizza'),
									_1: {ctor: '[]'}
								}
							}
						},
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('inputspinner'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$name('quantity'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$type_('text'),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('form-control text-center'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(m.temporder.selected.quantity),
											_1: {
												ctor: '::',
												_0: A2(_elm_lang$html$Html_Attributes$attribute, 'min', '1'),
												_1: {ctor: '[]'}
											}
										}
									}
							...
							_0: A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$PizzaOrderModel$IncrementQuantity),
											_1: {ctor: '[]'}
										}
									}
								},
					...
					_1: {
						...
						_0: A2(
							_elm_lang$html$Html$div,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$id('pizzadropdownwrapper'),
									_1: {ctor: '[]'}
								}
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('dropdown pizzadropdown'),
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('pizzadropdownmenu'),
											_1: {ctor: '[]'}
										}
									},
									{
										...
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('btn btn-success btn-sm dropdown-toggle pizzadropdownbutton'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$type_('button'),
													_1: {
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text('Select Pizza'),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$class('dropdown-menu pizzadropdownmenu'),
													_1: {
														ctor: '::',
														_0: A2(_elm_lang$html$Html_Attributes$attribute, 'aria-labelledby', 'dropdownMenuButton'),
														_1: {ctor: '[]'}
													}
												},
												{
													ctor: '::',
													_0: _user$project$PizzaOrderView$renderPizzaList(m.pizze),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Selected: '),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('selectedpizza'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
												_0: _elm_lang$html$Html$text(
													A2(
														_elm_lang$core$Basics_ops['++'],
														m.temporder.selected.pizzaname,
														A2(
															_elm_lang$core$Basics_ops['++'],
															' ',
															_elm_lang$core$Basics$toString(m.temporder.selected.price)))),
												_1: {ctor: '[]'}
											}),
										_1: {ctor: '[]'}
									}
...
var _user$project$PizzaOrderView$renderToppingSelect = function (p) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$id('toppingsselect'),
				_1: {ctor: '[]'}
			}
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('mx-auto titlefixed d-flex justify-content-center'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('ADDITIONAL TOPPINGS'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: _user$project$PizzaOrderView$renderToppingList(_user$project$PizzaOrderModel$toppingslist),
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$PizzaOrderView$renderPage = function (model) {
	var _p4 = model.page;
	if (_p4.ctor === 'HomePage') {
		return A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('container-fluid pagebody'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('col-3 border border-dark rounded mt-3 ml-4 mr-5'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _user$project$PizzaOrderView$renderPizzaSpinner(model),
													_1: {
														ctor: '::',
														_0: _user$project$PizzaOrderView$renderToppingSelect(model.temporder.selected),
														_1: {
															ctor: '::',
															_0: A2(
																_elm_lang$html$Html$div,
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$class('input-group addorderbuttonwrapper'),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
																	_0: A2(
																		_elm_lang$html$Html$button,
																		{
																			...
																			_0: _elm_lang$html$Html_Attributes$class(
																				A2(
																					_elm_lang$core$Basics_ops['++'],
																					'btn btn-success btn-sm addorderbutton',
																					_user$project$PizzaOrderView$defineAddOrderButtonState(model.temporder.selected))),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$type_('button'),
																				_1: {
																					ctor: '::',
																					_0: _elm_lang$html$Html_Events$onClick(_user$project$PizzaOrderModel$AddOrder),
																					_1: {ctor: '[]'}
																				}
																			}
																		},
																		{
																			ctor: '::',
																			_0: _elm_lang$html$Html$text('ADD TO CUSTOMER ORDER'),
																			_1: {ctor: '[]'}
																		}),
																	_1: {ctor: '[]'}
																}),
						...
						_1: {
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('col-3 border border-dark rounded mt-3 mr-4'),
									_1: {ctor: '[]'}
								},
								{
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('CUSTOMER'),
											_1: {ctor: '[]'}
										}),
									_1: {
										ctor: '::',
												...
												_0: A2(
													...
													},
													{
														...
														_0: A2(
															...
															{
																ctor: '::',
																_0: _elm_lang$html$Html_Attributes$class('row customerformrow'),
																_1: {ctor: '[]'}
															},
															{
																ctor: '::',
																_0: A2(
																	...
																	},
																	{
																		...
																		_0: A2(
																			...
																			{
																				ctor: '::',
																				_0: _elm_lang$html$Html_Attributes$class('customerformfieldwrapper'),
																				_1: {ctor: '[]'}
																			},
																			{
																				ctor: '::',
																			...
																			_0: A2(
																				...
																				},
																				{
																					...
																					_0: A2(
																						...
																						{
																							ctor: '::',
																							_0: _elm_lang$html$Html_Attributes$for('address'),
																							_1: {ctor: '[]'}
																						},
																						{
																							ctor: '::',
																				...
																				_0: A2(
																					...
																					},
																					{
																						...
																						_0: A2(
																							...
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html_Attributes$for('telephone'),
																								_1: {ctor: '[]'}
																							},
																							{
																								ctor: '::',
																								_0: _elm_lang$html$Html$text('Telephone'),
																								_1: {ctor: '[]'}
																							}),
																						_1: {
																							ctor: '::',
																							_0: A2(
																								...
																								{
																									ctor: '::',
																									_0: _elm_lang$html$Html_Attributes$id('telephone'),
																									_1: {
																										ctor: '::',
																										_0: _elm_lang$html$Html_Attributes$class('form-control'),
																										_1: {ctor: '[]'}
						...
						},
						{
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('col-3 mt-3 mr-4'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											},
											{
												...
												_0: A2(
													...
													{
														ctor: '::',
														_0: _elm_lang$html$Html$text('TEMPORARY ORDER'),
														_1: {ctor: '[]'}
													}),
												_1: {
													ctor: '::',
													_0: A2(
														...
														{
															ctor: '::',
															_0: _elm_lang$html$Html_Attributes$class('badge badge-success badge-pill orderbadge'),
															_1: {ctor: '[]'}
														},
														{
															ctor: '::',
															_0: _elm_lang$html$Html$text(
																_elm_lang$core$Basics$toString(
																	_elm_lang$core$List$length(model.temporder.ordered))),
															_1: {ctor: '[]'}
														}),
													_1: {ctor: '[]'}
												}
										...
										_1: {
											ctor: '::',
											_0: _user$project$PizzaOrderView$renderList(model.temporder.ordered),
											_1: {
												ctor: '::',
												_0: _user$project$PizzaOrderView$renderOrderFooter(model.temporder.ordered),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$div,
																...
																_elm_lang$html$Html$button,
																{
																	...
																	_0: _elm_lang$html$Html_Attributes$class(
																		A2(
																			_elm_lang$core$Basics_ops['++'],
																			'btn btn-success btn-sm addorderbutton ',
																			_user$project$PizzaOrderView$defineConfirmOrderButtonState(model.temporder))),
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$type_('button'),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onClick(_user$project$PizzaOrderModel$ConfirmOrder),
																			_1: {ctor: '[]'}
																		}
																	}
																},
														...
														_0: A2(
															...
															},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('btn btn-success btn-sm addorderbutton'),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$type_('button'),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Events$onClick(_user$project$PizzaOrderModel$CancelOrder),
																				_1: {ctor: '[]'}
																			}
																		}
																	},
				...
				_0: A2(
					...
					},
					{
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('col-3 mt-3 ml-4 mr-5'),
								_1: {ctor: '[]'}
							},
							{
								ctor: '::',
								...
								_1: {
									ctor: '::',
									_0: A2(
										_user$project$PizzaOrderView$renderOrdersTodo,
										_user$project$PizzaOrderBusinessLogic$getOrdersPending(model.orders),
										model.tableState),
									_1: {ctor: '[]'}
								}
							}),
							...
							_0: A2(
								...
								},
								{
									...
									_1: {
										ctor: '::',
										_0: A2(
											_user$project$PizzaOrderView$renderOrdersDone,
											_user$project$PizzaOrderBusinessLogic$getOrdersReady(model.orders),
											model.tableState),
										_1: {ctor: '[]'}
									}
								}),
...
var _user$project$PizzaOrderView$renderNavbar = function (model) {
	var _p5 = model.page;
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('container-fluid topbar'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$nav,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('navbar navbar-expand-lg navbar-light bg-faded'),
									_1: {ctor: '[]'}
								}
							},
							{
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$class('logotext mb-0'),
										_1: {ctor: '[]'}
									},
									{
										ctor: '::',
										_0: A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$src('/static/images/pizza-icon.png'),
												_1: {
													ctor: '::',
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html$text('       Pizza Cut'),
											_1: {ctor: '[]'}
										}
									}),
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$id('navbarNav'),
											_1: {
												ctor: '::',
													...
													_0: A2(
														...
														},
														{
															...
															_0: A2(
																...
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html_Attributes$class('activetab'),
																	_1: {ctor: '[]'}
																},
																{
																	ctor: '::',
																	_0: _elm_lang$html$Html$text('Take Order'),
																	_1: {ctor: '[]'}
																}),
															_1: {ctor: '[]'}
														}),
														...
														_0: A2(
															...
															},
															{
																...
																_0: A2(
																	...
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html_Attributes$class('nav-link inactivetab'),
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Attributes$href('#orders'),
																			_1: {
																				ctor: '::',
																				_0: _elm_lang$html$Html_Events$onClick(
																					_user$project$PizzaOrderModel$NewUrl('/#orders')),
																				_1: {ctor: '[]'}
																			}
																		}
																	},
																	{
																		ctor: '::',
																		_0: _elm_lang$html$Html$text('Orders'),
																		_1: {ctor: '[]'}
																	}),
																_1: {ctor: '[]'}
															}),
																...
																_elm_lang$html$Html$a,
																{
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: _elm_lang$html$Html_Events$onClick(
																				_user$project$PizzaOrderModel$NewUrl('/home')),
																			_1: {ctor: '[]'}
																		}
																	}
																},
...
var _user$project$PizzaOrderView$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _user$project$PizzaOrderView$renderNavbar(model),
			_1: {
				ctor: '::',
				_0: _user$project$PizzaOrderView$renderPage(model),
				_1: {ctor: '[]'}
			}
		});
};

var _user$project$PizzaOrder$init = F2(
	function (flags, location) {
		var initialstate = function () {
			var _p0 = flags;
			if (_p0.ctor === 'Just') {
				return _elm_lang$core$Native_Utils.update(
					_user$project$PizzaOrderModel$initialModel,
					{
						flags: _user$project$PizzaOrderModel$Flags(_p0._0.dummyflag),
						history: {
							ctor: '::',
							_0: location,
							_1: {ctor: '[]'}
				...
				return _user$project$PizzaOrderModel$initialModel;
			}
		}();
		return {
			ctor: '_Tuple2',
			_0: initialstate,
			_1: A2(_elm_lang$core$Task$perform, _user$project$PizzaOrderModel$CurrentTime, _elm_lang$core$Time$now)
		};
	});
var _user$project$PizzaOrder$setName = _elm_lang$core$Native_Platform.incomingPort('setName', _elm_lang$core$Json_Decode$string);
var _user$project$PizzaOrder$setAddress = _elm_lang$core$Native_Platform.incomingPort('setAddress', _elm_lang$core$Json_Decode$string);
var _user$project$PizzaOrder$setTelephone = _elm_lang$core$Native_Platform.incomingPort('setTelephone', _elm_lang$core$Json_Decode$string);
var _user$project$PizzaOrder$setPizza = _elm_lang$core$Native_Platform.incomingPort('setPizza', _elm_lang$core$Json_Decode$string);
var _user$project$PizzaOrder$setTopping = _elm_lang$core$Native_Platform.incomingPort('setTopping', _elm_lang$core$Json_Decode$string);
var _user$project$PizzaOrder$removeTopping = _elm_lang$core$Native_Platform.incomingPort('removeTopping', _elm_lang$core$Json_Decode$string);
var _user$project$PizzaOrder$setQuantity = _elm_lang$core$Native_Platform.incomingPort('setQuantity', _elm_lang$core$Json_Decode$string);
var _user$project$PizzaOrder$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$batch(
		{
			ctor: '::',
			_0: _user$project$PizzaOrder$setName(_user$project$PizzaOrderModel$InputName),
			_1: {
				ctor: '::',
				_0: _user$project$PizzaOrder$setAddress(_user$project$PizzaOrderModel$InputAddress),
				_1: {
					ctor: '::',
					_0: _user$project$PizzaOrder$setTelephone(_user$project$PizzaOrderModel$InputTelephone),
					_1: {
						ctor: '::',
						_0: _user$project$PizzaOrder$setPizza(_user$project$PizzaOrderModel$SetPizza),
						_1: {
							ctor: '::',
							_0: _user$project$PizzaOrder$setTopping(_user$project$PizzaOrderModel$SetTopping),
							_1: {
								ctor: '::',
								_0: _user$project$PizzaOrder$removeTopping(_user$project$PizzaOrderModel$RemoveTopping),
								_1: {
									ctor: '::',
									_0: _user$project$PizzaOrder$setQuantity(_user$project$PizzaOrderModel$Quantity),
									_1: {ctor: '[]'}
								}
							}
						}
...
var _user$project$PizzaOrder$main = A2(
	_elm_lang$navigation$Navigation$programWithFlags,
	_user$project$PizzaOrderModel$UrlChanged,
	{init: _user$project$PizzaOrder$init, view: _user$project$PizzaOrderView$view, update: _user$project$PizzaOrderUpdate$update, subscriptions: _user$project$PizzaOrder$subscriptions})(
			...
			_1: {
				...
				_0: A2(
					...
					A2(
						...
						A2(_elm_lang$core$Json_Decode$field, 'dummyflag', _elm_lang$core$Json_Decode$int))),
				_1: {ctor: '[]'}
			}
		}));

var Elm = {};
Elm['PizzaOrder'] = Elm['PizzaOrder'] || {};
if (typeof _user$project$PizzaOrder$main !== 'undefined') {
    _user$project$PizzaOrder$main(Elm['PizzaOrder'], 'PizzaOrder', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Table.State":{"args":[],"tags":{"State":["String","Bool"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}},"PizzaOrderModel.Msg":{"args":[],"tags":{"ConfirmOrder":[],"CurrentTime":["Time.Time"],"InputTelephone":["String"],"SetPizza":["String"],"RemoveTopping":["String"],"CancelOrder":[],"InputAddress":["String"],"Quantity":["String"],"SetTableState":["Table.State"],"ToggleSelected":["PizzaOrderModel.PizzaOrder"],"InputName":["String"],"Pizze":["Result.Result Http.Error (List PizzaOrderModel.Pizza)"],"AddOrder":[],"NewUrl":["String"],"IncrementQuantity":[],"Orders":["Result.Result Http.Error (List PizzaOrderModel.OrderDto)"],"SelectPizza":["PizzaOrderModel.Pizza"],"OrderCreated":["Result.Result Http.Error PizzaOrderModel.OrderDto"],"NoOp":[],"UrlChanged":["Navigation.Location"],"SetTopping":["String"]}}},"aliases":{"PizzaOrderModel.Pizza":{"args":[],"type":"{ id : String, name : String, price : String, description : String }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"PizzaOrderModel.Topping":{"args":[],"type":"{ id : String, name : String }"},"PizzaOrderModel.OrderDto":{"args":[],"type":"{ id : String , pizza : String , quantity : String , price : Float , total : Float , pending : Bool , ready : Bool , customer : String }"},"Time.Time":{"args":[],"type":"Float"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"},"PizzaOrderModel.PizzaOrder":{"args":[],"type":"{ pizzaname : String , pizzaid : String , toppings : List PizzaOrderModel.Topping , size : String , quantity : String , price : Float , total : Float , customer : String , timestamp : String , pending : Bool , ready : Bool }"}},"message":"PizzaOrderModel.Msg"},"versions":{"elm":"0.18.0"}});
}
