...
var _kujua$bookcompanion_elm$GFModel$Model = F3(
	function (a, b, c) {
		return {x: a, y: b, stage: c};
	});
var _kujua$bookcompanion_elm$GFModel$Stop = function (a) {
	return {ctor: 'Stop', _0: a};
};
var _kujua$bookcompanion_elm$GFModel$Start = function (a) {
	return {ctor: 'Start', _0: a};
};
var _kujua$bookcompanion_elm$GFModel$Position = F2(
	function (a, b) {
		return {ctor: 'Position', _0: a, _1: b};
	});

var _kujua$bookcompanion_elm$GFInit$initialModel = {x: 0, y: 0, stage: true};
var _kujua$bookcompanion_elm$GFInit$init = {ctor: '_Tuple2', _0: _kujua$bookcompanion_elm$GFInit$initialModel, _1: _elm_lang$core$Platform_Cmd$none};

var _kujua$bookcompanion_elm$GFUpdate$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'Start':
...
var _kujua$bookcompanion_elm$GFView$view = function (model) {
	return A2(
...
var _kujua$bookcompanion_elm$GamesFramework$subscriptions = function (model) {
	return _elm_lang$mouse$Mouse$moves(
		function (_p0) {
			var _p1 = _p0;
			return A2(_kujua$bookcompanion_elm$GFModel$Position, _p1.x, _p1.y);
		});
};
var _kujua$bookcompanion_elm$GamesFramework$main = _elm_lang$html$Html$program(
	{init: _kujua$bookcompanion_elm$GFInit$init, view: _kujua$bookcompanion_elm$GFView$view, update: _kujua$bookcompanion_elm$GFUpdate$update, subscriptions: _kujua$bookcompanion_elm$GamesFramework$subscriptions})();
var _kujua$bookcompanion_elm$GamesFramework$check = _elm_lang$core$Native_Platform.outgoingPort(
	'check',
	function (v) {
		return v;
	});
var _kujua$bookcompanion_elm$GamesFramework$suggestions = _elm_lang$core$Native_Platform.incomingPort(
	'suggestions',
	_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string));

var Elm = {};
Elm['GamesFramework'] = Elm['GamesFramework'] || {};
if (typeof _kujua$bookcompanion_elm$GamesFramework$main !== 'undefined') {
    _kujua$bookcompanion_elm$GamesFramework$main(Elm['GamesFramework'], 'GamesFramework', undefined);
}
